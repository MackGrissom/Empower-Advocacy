...
import background from '/home/mackgrissom/code/MackGrissom/Empower-Advocacy/Empower-Advocacy/src/assets/images/background3.webp'
const navigation = [
  { name: 'Home', href: '#' },
  { name: 'About', href: '#' },
  { name: 'Services', href: '#' },
...
export default function Hero() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-[black] h-[100vh]">
      <img
        src={background}
        alt=""
      ...
      <div className="px-6 lg:px-8">
        <nav className="flex items-center justify-between pt-6" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <a key={item.name} href={item.href} className="text-sm font-semibold leading-6 text-beige">
                {item.name}
              </a>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-5xl py-20 sm:py-20 lg:py-20 w-[100%]">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-beige sm:text-3xl w-[100%]">
           <span className='text-gn'> Empowering </span> Families To Navigate   Special  Education. </h1>
            <div className="flex justify-center align-middle text-center">
            <p className="mt-6 text-md leading-6 max-w-2xl text-[white]">
            Our mission is to empower  you to advocate for your child in the school system. Parents are often left feeling alone at the table during an IEP meeting. We help change that 
            </p>
            </div>
